import 'package:blind_date/models/member.dart';
import 'package:blind_date/widgets/member_item.dart';
import 'package:flutter/material.dart';

class GridScreen extends StatelessWidget {
  GridScreen({super.key});
  final List<Members> loadedMembers = [
    Members(
      id: 'p1',
      title: '1',
      description: '1',
  ...
  Widget build(BuildContext context) {
    return GridView.builder(
      ...
      itemBuilder: (context, index) => MemberItem(
        loadedMembers[index].id,
        loadedMembers[index].title,
        loadedMembers[index].imageUrl,
      ),
      itemCount: loadedMembers.length, // number of GridView
    );
  }
}
